# Variable Resolver Design for Biscuit Compiler
...
4. **Biscuit Extensions**: Support Biscuit-specific constructs like view parameters
...
type Resolver struct {
    ...
    InViewScope     bool                  // Biscuit views
...
Biscuit view parameters need special handling for the transformation phase:
...
5. **Biscuit-specific constructs**: Slot parameters, special view behaviors 