...
class CodeComparison(BaseView):
    ...
    def _render(self) -> Element:
        ...
        _div_children_7000 = []
        _div_children_7000.append(el("div", "view Greeting(name: str):"))
        _div_children_7000.append(el("div", "&lt;div class=\"card\"&gt;", {"class": "ml-4"}))
        _div_children_7000.append(el("div", "&lt;h1&gt;Hello, name&lt;/h1&gt;", {"class": "ml-8"}))
        _div_children_7000.append(el("div", "&lt;/div&gt;", {"class": "ml-4"}))
        _div_children_6000.append(el("div", _div_children_7000, {"class": "bg-slate-900 rounded-lg p-4 font-mono text-sm text-slate-300"}))
        _div_children_5000.append(el("div", _div_children_6000))
        _div_children_8000 = []
        _div_children_8000.append(el("h3", "output.py", {"class": "text-pink-400 font-mono text-sm mb-3"}))
        _div_children_9000 = []
        _div_children_9000.append(el("div", "class Greeting(BaseView):"))
        _div_children_9000.append(el("div", "def __init__(self, name: str):", {"class": "ml-4"}))
        _div_children_9000.append(el("div", "self.name = name", {"class": "ml-8"}))
        _div_children_9000.append(el("div", "def _render(self):", {"class": "ml-4"}))
        _div_children_9000.append(el("div", "return el(\"div\", ...)", {"class": "ml-8"}))
        _div_children_8000.append(el("div", _div_children_9000, {"class": "bg-slate-900 rounded-lg p-4 font-mono text-sm text-slate-300"}))
        _div_children_5000.append(el("div", _div_children_8000))
