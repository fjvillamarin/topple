...
1. **[parser-bug-05-async-view-support.md](parser-bug-05-async-view-support.md)**
...
2. **[parser-bug-07-target-parsing.md](parser-bug-07-target-parsing.md)**
   - **Status**: Mostly fixed, 3 edge cases remaining
   - **Impact**: Complex target parsing edge cases
